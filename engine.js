...
const Engine = {
  ...
  menus: {
    default_premium: {
      ...
      L: ['Tortilla de 3 huevos orgánicos + aguacate + arándanos', 'Salmón salvaje/Pescado graso + quinoa + espárragos', 'Crema de calabaza + pechuga de pavo + nueces'],
      M: ['Bowl de yogur griego + chía + frutos rojos', 'Pechuga de pollo de corral + batata asada + brócoli con aceite de oliva', 'Ensalada de espinaca, atún al natural, tomates cherry y almendras'],
      X: ['Smoothie verde (Espinaca, manzana verde, apio, espirulina)', 'Corte de res magro (ej. Lomito) + arroz salvaje + ensalada mixta', 'Filete de pescado al horno + vegetales asados'],
      J: ['Pancakes de avena y proteína + fresas + crema de cacahuate', 'Pechuga de pollo + ensalada de aguacate, tomate y pepino', 'Sopa de vegetales densa + trozos de pollo'],
      V: ['Tostadas de pan de masa madre + salmón ahumado + huevo pochado', 'Lomo de cerdo magro + puré de papa + zanahorias baby', 'Ensalada capresa (Mozzarella, tomate, albahaca) + pollo a la plancha'],
      S: ['Avena horneada con manzana, canela y almendras', 'Bowl de quinoa, caraotas negras, aguacate y carne molida', 'Sándwich de pan integral con pavo, queso fresco y vegetales'],
      D: ['Omelette de claras con espinaca y champiñones + té matcha', 'Pasta integral o de lentejas con salsa boloñesa (res magra)', 'Sopa ligera + porción de pescado blanco'],
    },
    default_q1: {
      L: ['Huevos revueltos + aguacate + fruta', 'Arroz integral + pollo a la plancha + ensalada', 'Sopa de vegetales + pan integral'],
      M: ['Avena con fruta + nueces', 'Lentejas guisadas + arroz + tajadas', 'Ensalada de atún con vegetales'],
      X: ['Smoothie verde + tostadas integrales', 'Pollo al horno + yuca cocida + ensalada', 'Caraotas negras + plátano + queso'],
      J: ['Yogur natural + granola + fruta', 'Pescado al vapor + arroz + brócoli', 'Crema de verduras + huevo duro'],
      V: ['Arepa integral + queso blanco + aguacate', 'Res magra + papas al horno + vegetales', 'Ensalada completa + atún'],
      S: ['Pancakes de avena + frutas', 'Pollo guisado + caraotas + arroz', 'Sandwich integral + sopa'],
      D: ['Frutas mixtas + nueces + té verde', 'Pasta integral + vegetales salteados', 'Sopa ligera + pan'],
    },
    default_econ: {
      L: ['Jugo Funcional del Día + 2 Huevos Duros', 'Lentejas guisadas (abundantes) + arroz blanco', 'Arepa asada + queso blanco'],
      M: ['Avena hervida con agua + 1 fruta de estación', 'Arroz + sardinas o atún enlatado + tomate', 'Plátano sancochado + 1 huevo revuelto'],
      X: ['Jugo Funcional del Día + 1 Pan o Arepa sola', 'Caraotas negras + yuca sancochada', 'Ensalada de repollo/zanahoria + 2 huevos'],
      J: ['Avena hervida + canela (sin leche)', 'Pasta + sardinas en salsa de tomate', 'Sopa o caldo de verduras económico'],
      V: ['Jugo Funcional del Día + 2 Huevos Duros', 'Lentejas guisadas + tajadas de plátano', 'Arepa asada + mantequilla/queso'],
      S: ['Pan + tortilla de 1 huevo', 'Arroz + vegetales de hoja salteados + 1 huevo', 'Caraotas negras + pan'],
      D: ['Avena con agua + fruta', 'Sopa de vegetales densa (con papa y yuca)', 'Plátano sancochado + queso'],
    }
  },
